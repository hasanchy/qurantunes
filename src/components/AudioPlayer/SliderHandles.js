...
class SliderHandles extends Component {
    ...
    renderCircle(){
        return <div id={this.state.handleId} style={{cursor:"pointer",width:"28px",height:"28px",backgroundColor:"#134F63",borderRadius:"50%",position:"absolute",top:"-18px",marginLeft:"-13px",opacity:"1",transform:"scale(1)",boxShadow:"0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)"}}>
    ...
    renderHandles(){
        return (
            <div style={{position:"absolute",left:this.state.position,zIndex:"100"}}>
                {this.renderCircle()}
            </div>
        )
    }
